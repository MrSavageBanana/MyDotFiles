...
(function () {
  ...
  function markdownEditor() {
    const addAttachmentsWrapper = document.querySelector(
      '.NotesEditor > .toolbar:not([data-markdown-editor="true"])',
    );
  ...
  addStyle(
    [
      ...
      ".NotesEditor > .toolbar .notes-custom { width: 28px; height: 28px; margin-right: 0; padding: 5px; border: 1px solid transparent; border-radius: var(--radius); background-color: transparent; background-image: linear-gradient(var(--colorBgLight), var(--colorBg)); }",
