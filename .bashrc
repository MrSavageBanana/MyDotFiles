...
source /home/shayan/.dircolors_cache # run the following to get the file: dircolors -b > ~/.dircolors_cache
...
alias lock='hyprlock & sleep 0 && systemctl suspend'
alias lockx='hyprlock & sleep 0 && systemctl suspend && x'
alias nano='micro'
...
alias fk="fuck"
alias tk="fuck"
alias clip2img='copyq read image/png 0 > ~/Pictures/clip2img/$(date +%Y-%m-%d_%H%M%S).png'
alias tldr='tldr --compact'
alias 'historyim'='atuin history list | nl' # history improved
...
# --- Zoxide Setup ---
source /home/shayan/.zoxide-init.bash # run this command to create the file: "zoxide init bash > ~/.zoxide-init.bash"
...
# commenting this out in case i need it back
...
source /home/shayan/.fzf_static.bash
# Shellfirm
...
# run starship init bash > ~/.starship_static_init.sh
# eval "$(starship init bash)"
source /home/shayan/.starship_static_init.sh

. "$HOME/.atuin/bin/env"

[[ -f /home/shayan/.bash-preexec.sh ]] && source /home/shayan/.bash-preexec.sh
# Run atuin init bash --disable-ctrl-r --disable-up-arrow > ~/.atuin_static_init.sh && sed -i 's/ATUIN_SESSION=$(atuin uuid)/ATUIN_SESSION=$(cat \/proc\/sys\/kernel\/random\/uuid)/' ~/.atuin_static_init.sh 
# eval "$(atuin init bash --disable-ctrl-r --disable-up-arrow)"
source /home/shayan/.atuin_static_init.sh
