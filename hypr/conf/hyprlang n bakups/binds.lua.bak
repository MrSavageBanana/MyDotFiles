...
hl.bind(mainMod .. " + A", hl.dsp.exec_cmd("kitty --class=popup_term -e bash /home/shayan/.local/bin/VP"))
...
-- Rofi launcher
hl.bind(mainMod .. " + SPACE", hl.dsp.exec_cmd("bash /home/shayan/.config/rofi/launchers/type-7/launcher.sh"))

-- Pseudotile toggle (SUPER+G)
-- TODO: verify hl.dsp.window.pseudo() exists, or keep hyprctl fallback
hl.bind(mainMod .. " + G", hl.dsp.exec_cmd("hyprctl dispatch pseudo active"))
...
-- Screen rotate
hl.bind(mainMod .. " + SHIFT + R", hl.dsp.exec_cmd("/home/shayan/.config/hypr/scripts/rotate.sh"))

-- Send right-arrow shortcut (Vivaldi tab nav etc.), repeating
hl.bind(mainMod .. " + TAB", hl.dsp.exec_cmd("hyprctl dispatch sendshortcut ',right,'"), { repeating = true })
...
hl.bind(mainMod .. " + H", hl.dsp.exec_cmd("~/.config/hypr/scripts/workspace_nav.sh prev"), { repeating = true })
hl.bind(mainMod .. " + L", hl.dsp.exec_cmd("~/.config/hypr/scripts/workspace_nav.sh next"), { repeating = true })

-- Move window to prev/next workspace (SUPER + SHIFT + h/l)
hl.bind(mainMod .. " + SHIFT + H", hl.dsp.exec_cmd("~/.config/hypr/scripts/ws-move-prev.sh"), { repeating = true })
hl.bind(mainMod .. " + SHIFT + L", hl.dsp.exec_cmd("~/.config/hypr/scripts/ws-move-next.sh"), { repeating = true })

-- Move focus (SUPER + ALT + hjkl) -- TODO: replace with hl.dsp.window.focus_direction() if available
hl.bind(mainMod .. " + ALT + H", hl.dsp.exec_cmd("hyprctl dispatch movefocus l"), { repeating = true })
hl.bind(mainMod .. " + ALT + J", hl.dsp.exec_cmd("hyprctl dispatch movefocus d"), { repeating = true })
hl.bind(mainMod .. " + ALT + K", hl.dsp.exec_cmd("hyprctl dispatch movefocus u"), { repeating = true })
hl.bind(mainMod .. " + ALT + L", hl.dsp.exec_cmd("hyprctl dispatch movefocus r"), { repeating = true })

-- Move window (SUPER + CTRL + hjkl) -- TODO: replace with hl.dsp.window.move({ direction = }) if available
hl.bind(mainMod .. " + CTRL + H", hl.dsp.exec_cmd("hyprctl dispatch movewindow l"), { repeating = true })
hl.bind(mainMod .. " + CTRL + J", hl.dsp.exec_cmd("hyprctl dispatch movewindow d"), { repeating = true })
hl.bind(mainMod .. " + CTRL + K", hl.dsp.exec_cmd("hyprctl dispatch movewindow u"), { repeating = true })
hl.bind(mainMod .. " + CTRL + L", hl.dsp.exec_cmd("hyprctl dispatch movewindow r"), { repeating = true })
...
hl.bind(mainMod .. " + S", hl.dsp.exec_cmd("~/.config/hypr/scripts/gotospecial.sh extra"))
hl.bind(mainMod .. " + D", hl.dsp.exec_cmd("~/.config/hypr/scripts/gotospecial.sh dashboard"))
hl.bind(mainMod .. " + SHIFT + D", hl.dsp.exec_cmd("~/.config/hypr/scripts/movetospecial.sh special:dashboard"))
hl.bind(mainMod .. " + SHIFT + S", hl.dsp.exec_cmd("~/.config/hypr/scripts/movetospecial.sh special:extra"))
...
hl.bind(
	mainMod .. " + X",
	hl.dsp.exec_cmd(
		'hyprctl dispatch sendshortcut "CTRL ALT SHIFT,I,activewindow" && hyprctl dispatch sendshortcut "SHIFT,F10,activewindow"'
	)
)
